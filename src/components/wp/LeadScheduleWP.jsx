...
export default function LeadScheduleWP({ wp }){
  const { cfg, ind, tbData, setTbData, tbMappings, setTbMappings, coaMod } = useEngagement();
  const { BoundET, ST, inp } = useAuditHelpers();
