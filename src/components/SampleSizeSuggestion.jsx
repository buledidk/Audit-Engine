...
const SampleMethodCard = ({ title, data, isRecommended = false }) => (
  <div style={{
    background: isRecommended ? `${SAMPLE_COLORS.accent}15` : SAMPLE_COLORS.card,
    border: `1px solid ${isRecommended ? `${SAMPLE_COLORS.accent}40` : SAMPLE_COLORS.border}`,
    borderLeft: `4px solid ${isRecommended ? SAMPLE_COLORS.accent : SAMPLE_COLORS.dim}`,
    borderRadius: "8px",
    padding: "16px",
    marginBottom: "12px"
  }}>
    <div style={{
      ...
      <div>
        <h4 style={{
          color: isRecommended ? SAMPLE_COLORS.accent : SAMPLE_COLORS.text,
          margin: "0 0 4px 0",
          fontSize: "13px",
          fontWeight: 700
        }}>
    ...
    <div style={{
      ...
      <div>
        <p style={{ color: SAMPLE_COLORS.dim, margin: "0 0 4px 0", fontSize: "9px", fontWeight: 700 }}>
          SAMPLE SIZE
        </p>
        <p style={{
          color: isRecommended ? SAMPLE_COLORS.accent : SAMPLE_COLORS.text,
        ...
        <p style={{ color: SAMPLE_COLORS.dim, margin: "4px 0 0 0", fontSize: "10px" }}>
    ...
    {data.reason && (
      <div style={{
        ...
        borderRadius: "4px",
        borderLeft: `2px solid ${SAMPLE_COLORS.accent}`,
        color: SAMPLE_COLORS.dim,
        fontSize: "10px"
      }}>
        {'\u{1F4CC}'} {data.reason}
